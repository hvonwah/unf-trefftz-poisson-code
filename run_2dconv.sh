...
/usr/bin/time -v python3 conv_study.py --example 1 --n_ref 7 --order 2 -def 0 --method trefftz --stabil aggregation
...
/usr/bin/time -v python3 conv_study.py --example 1 --n_ref 7 --order 2 -def 0 --method l2 --stabil aggregation
...
/usr/bin/time -v python3 conv_study.py --example 1 --n_ref 7 --order 3 -def 0 --method trefftz --stabil aggregation
...
/usr/bin/time -v python3 conv_study.py --example 1 --n_ref 7 --order 3 -def 0 --method l2 --stabil aggregation
...
/usr/bin/time -v python3 conv_study.py --example 1 --n_ref 5 --order 4 -def 0 --method trefftz --stabil aggregation
...
/usr/bin/time -v python3 conv_study.py --example 1 --n_ref 5 --order 4 -def 0 --method l2 --stabil aggregation
...
/usr/bin/time -v python3 conv_study.py --example 1 --n_ref 4 --order 5 -def 0 --method trefftz --stabil aggregation
...
/usr/bin/time -v python3 conv_study.py --example 1 --n_ref 4 --order 5 -def 0 --method l2 --stabil aggregation
